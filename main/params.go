...
import (
	...
	"github.com/corpetty/avalanchego/database/leveldb"
	...
	"github.com/corpetty/avalanchego/staking"
	...
	"github.com/corpetty/avalanchego/utils/ulimit"
...
func setNodeConfig(v *viper.Viper) error {
	...
	// Network Parameters
	if networkID != constants.MainnetID && networkID != constants.FujiID && networkID != constants.StatalancheID {
