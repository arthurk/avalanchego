...
<<<<<<< HEAD
CORETH_VER="v0.3.25-0.20210222215831-1e755bfe0032"
=======
CORETH_VER="v0.3.26"
>>>>>>> v1.2.3

CORETH_PATH="$GOPATH/pkg/mod/github.com/corpetty/coreth@$CORETH_VER"
...
if [[ $# -eq 2 ]]; then
    ...
    if [[ ! -d "$CORETH_PATH" ]]; then
        go get "github.com/corpetty/coreth@$CORETH_VER"
    fi
else
